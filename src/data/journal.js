...
const journalArticles = [
  {
    ...
    content: [
      ...
      "As the garden develops, we'll share updates about what we're growing, what we're learning, and what eventually makes its way from the garden to the table.",
    ],
  },

  {
    ...
    content: [
      ...
      "This journal is where we'll document those moments and keep a record of how the farm changes over time.",
    ],
  },

  {
    ...
    content: [
      ...
      "The result is a simple space where guests can experience the countryside without completely separating themselves from it.",
    ],
  },

  {
    ...
    content: [
      ...
      "Seasonal farming helps us understand the land better and keeps the farm connected to its natural rhythm.",
    ],
  },

  {
    ...
    content: [
      "One of the reasons we enjoy farming is the direct connection between growing food and eating it.",
      "There is something different about preparing a meal with ingredients that were growing nearby only a short time earlier.",
      "That connection between land, food, and people is something we want to make central to the Mondol's Farm experience.",
    ],
  },

  {
    ...
    content: [
      ...
      "We're documenting the process because the journey is just as important as the finished farm.",
    ],
  },
];
